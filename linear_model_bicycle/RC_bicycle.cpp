...
//int main()
{
	...
	double phi_0_max = atof(argv[12]);
        ...
        double v_noise_min = atof(argv[17]);
        double v_noise_max = atof(argv[18]);
        double delta_noise_min = atof(argv[19]);
        double delta_noise_max = atof(argv[20]);
        double step = atof(argv[21]);
	...
	Interval init_x(x_0_min, x_0_max), init_y(y_0_min, y_0_max), init_phi(phi_0_min, phi_0_max), init_v(v_0_min, v_0_max), init_delta(delta_0_min, delta_0_max), init_v_noise(v_noise_min, v_noise_max), init_delta_noise(delta_noise_min, delta_noise_max), init_t;															
...
//        plot_setting.setOutputDims(t_id, v_id);
        //int indicator = 1;
